//
//  HelpSubmitCallViewController.m
//  DataLinkDM
//
...
@interface HelpSubmitCallViewController ()

@end

@implementation HelpSubmitCallViewController
...
- (IBAction)submitAction:(id)sender {
    ...
    NSString* phoneNumber = self.phoneNumberTextView.text;
        [self serviceSubmitHelp:question withCallNumber:phoneNumber withMode:2];
}
