...
#define HOURARRAY @[@"0点", @"1h", @"2h", @"3h", @"4h", @"5h", @"6h", @"7h", @"8h", @"9h", @"10h", @"11h", @"12h", @"13h", @"14h", @"15h", @"16h", @"17h", @"18h", @"19h", @"20h"]
#define MINUTEARRAY @[@"0m", @"10m", @"20m", @"30m", @"40m", @"50m"]
...
- (IBAction)sureBtnAction:(id)sender {
    if(self.completeBlock){
        ...
        NSMutableString *dateValue = [[NSMutableString alloc] initWithString:[self formatOriArray:_hourArray][firstIndex]];
        [dateValue appendString:[self formatOriArray:_minuteArray][secodnIndex]];
        infoDic[@"time_value"] = dateValue;
        infoDic[@"time_hour"] = [self formatOriArray:_hourArray][firstIndex];
        infoDic[@"time_min"] = [self formatOriArray:_minuteArray][secodnIndex];
